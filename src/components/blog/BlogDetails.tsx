...
const BlogDetails: React.FC<BlogDetailsProps> = ({ blog, slug: blogSlug }) => {
   // console.log(blog);
   return (
      <div className="px-2 sm:px-10 text-light/50 py-2 flex items-center justify-center text-center flex-wrap text-sm sm:text-md md:text-lg lg:text-xl font-medium mx-1 sm:mx-5 md:mx-10">
