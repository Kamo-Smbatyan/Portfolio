               ...
               <div className="p-6">
                  <div className="inline-block pb-4">
                     ...
                     <svg
                        ...
                        fill="#163898"
                        className="relative bottom-1 w-full"
                     >
                     ...
                     >
                        <div className="flex items-start space-y-4">
                           <div className="w-1/4 flex justify-center">
                              <Image
                                 className="relative h-auto w-auto my-4"
                                 src={card.image}
                                 alt={card.experienceName}
                                 width={50}
                              />
                           </div>
                        ...
                        <div
                           className={`w-full text-left pt-2 px-8 tracking-normal transition-all duration-500 ease-in-out overflow-hidden ${selectedEdCard === index ? 'max-h-screen' : 'max-h-0'}`}
                        >
