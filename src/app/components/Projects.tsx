...
function Projects() {
   ...
   const projectCards = [salonnMobileCard, salonnVrCard, oliCard, socialCard, portfolioCard];
   return (
      <div id="projects" className="w-full py-16 bg-black text-white">
         ...
         <div className="grid lg:grid-cols-2 gap-x-16 gap-y-8 pt-10 px-8 sm:px-16 md:px-32 lg:px-0 xl:px-16  mx-auto">
            {projectCards.map((card, index) => (
               <div key={index} className="p-4 rounded-lg items-center relative overflow-hidden">
                  <div
                  ...
                  <div className="relative z-10 py-4 lg:pt-5 lg:pb-8 px-6 sm:px-14 md:px-16 lg:px-20">
                     ...
                     <p className="text-xs md:text-base">
                        ...
                        <a
                           ...
                           className="underline text-salonnblue">
                           Learn more...
                        </a>
                     </p>
                  </div>
